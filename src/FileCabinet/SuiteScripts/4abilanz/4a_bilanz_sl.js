 ...
 */
define([
  'N/ui/serverWidget', 'N/query', 'N/url', 'N/runtime', 'N/render', 'N/file', 'N/log',
  './4a_bilanz_style', './4a_bilanz_config', './4a_bilanz_queries',
  './4a_bilanz_pdf', './4a_bilanz_xlsx', './4a_bilanz_license',
], (serverWidget, query, url, runtime, render, file, log,
    style, config, queries, pdfMod, xlsxMod, license) => {
